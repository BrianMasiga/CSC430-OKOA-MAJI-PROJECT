        ...
        <div class="col-lg-12">
            ...
            <div class="card">
              ...
              <div class="card-body pb-0">
                ...
                <h5 class="card-title">User Contributions<span>| 
...
if ($result->num_rows > 0) {
  while($row = $result->fetch_assoc()) {
    echo '<div class="article alert alert-info">';
 ...
 <hr>
          ...
          <div class="col-lg-12" id="admin-section">
            <div class="card">
              ...
              <div class="card-body pb-0 alert alert-success">
...
$stmt = $conn->prepare("INSERT INTO articles (title, image_url, content) VALUES (?, ?, ?)");
